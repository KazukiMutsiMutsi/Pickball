      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.statsRow}>
          {[
            ...
            <View key={s.label} style={[styles.statCard, shadowSm]}>
        ...
        <View style={[styles.menu, shadowSm]}>
...
const styles = StyleSheet.create({
  ...
  statCard:       { flex: 1, backgroundColor: '#fff', borderRadius: Radius.md, padding: Spacing.md, alignItems: 'center' },
