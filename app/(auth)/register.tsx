...
const styles = StyleSheet.create({
  ...
  phoneRow:        { flexDirection: 'row', borderWidth: 1.5, borderColor: Palette.grey300, borderRadius: Radius.md, backgroundColor: Palette.grey50, overflow: 'hidden', alignItems: 'center' },
  phPrefix:        { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 12, paddingVertical: 14, borderRightWidth: 1.5, borderRightColor: Palette.grey300, backgroundColor: Palette.primaryLight, gap: 5 },
  phFlag:          { fontSize: 18 },
  phCode:          { fontSize: 14, fontWeight: '800', color: Palette.primary },
  phoneInput:      { flex: 1, fontSize: 16, color: Palette.grey900, paddingHorizontal: Spacing.md, paddingVertical: 14, letterSpacing: 1 },
