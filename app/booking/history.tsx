...
const MOCK: BookingRecord[] = [
  { id: 'BKG-A1B2C3', courtName: 'Downtown Pickleball Center', date: '2026-07-12', startTime: '09:00', endTime: '11:00', duration: 2, total: 42, status: 'upcoming', paymentMethod: 'Credit / Debit Card' },
  ...
  { id: 'BKG-J1K2L3', courtName: 'Northpark Arena', date: '2026-06-15', startTime: '10:00', endTime: '12:00', duration: 2, total: 46.2, status: 'cancelled', paymentMethod: 'Credit / Debit Card' },
];
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: '#fff', borderRadius: Radius.md, padding: Spacing.md, ...shadowMd },
  ...
  bookingId: { fontSize: 11, color: Palette.grey500, fontFamily: 'monospace' },
