...
export const STAFF_BOOKINGS: StaffBooking[] = [
  ...
  { id: 'BKG-002', playerName: 'Maria Santos',      playerPhone: '+63 918 234 5678', courtId: 'c1', courtName: 'Court 1', date: TODAY, startTime: '10:00', endTime: '11:30', durationHrs: 1.5, companions: 1, amount: 315,  paid: true,  status: 'confirmed'  },
  { id: 'BKG-003', playerName: 'Pedro Reyes',       playerPhone: '+63 919 345 6789', courtId: 'c1', courtName: 'Court 1', date: TODAY, startTime: '10:00', endTime: '12:00', durationHrs: 2,   companions: 2, amount: 378,  paid: false, status: 'confirmed'  },
  ...
  { id: 'BKG-019', playerName: 'Teresa Magbanua',   playerPhone: '+63 918 999 0000', courtId: 'c2', courtName: 'Court 2', date: d(12), startTime: '14:00', endTime: '15:30', durationHrs: 1.5, companions: 0, amount: 315,  paid: false, status: 'confirmed'  },
